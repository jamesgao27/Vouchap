...
export const WEB_POPOVER = {
  ...
  optionRow: { paddingTop: 10, paddingBottom: 10, paddingLeft: 12, paddingRight: 12, borderRadius: 8, minHeight: 40 },
  optionText: { fontSize: 13, color: '#2D3436', fontWeight: '500' as const },
