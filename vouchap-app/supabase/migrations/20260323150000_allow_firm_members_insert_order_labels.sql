-- Allow firm members (not only admins) to add labels into firm.order_labels.
-- This supports UI behavior: user can add a new classification label during order edit.
...
CREATE POLICY firm_order_labels_insert_member ON firm.order_labels
